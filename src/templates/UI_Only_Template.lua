-- [[ VANTAGE HUB UI ONLY TEMPLATE ]]
-- Copy this file and replace example callbacks with your own logic.
-- This file is self-contained for one-file runner usage.
...
-- [ EXAMPLE UI WIRING ]
-- =============================================================================
local Window = Library:CreateWindow("VANTAGE HUB", "Example Project")

local MainTab = Window:CreateTab("Main")
local SettingsTab = Window:CreateTab("Settings")

MainTab:CreateToggle("Example Toggle", "เปิด/ปิดตัวอย่าง", false, function(state)
